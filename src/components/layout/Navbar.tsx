				...
				<nav
					className={`flex items-center justify-between border-transparent transition-all duration-500 ease-out ${
						scrolled
							...
							: "w-[min(1100px,calc(100vw-3rem))] px-4 md:px-8 py-4"
					}`}
				>
					<div className="flex items-center gap-4">
						...
						>
							<div
								className={`hidden md:flex rounded-xl items-center justify-center transition-all duration-500 ${scrolled ? "w-7 h-7" : "w-9 h-9"}`}
							>
								<Image
									src="/logo.svg"
									alt="Logo"
					...
					<div className="flex justify-end gap-4">
						...
						<Link
							...
							className={`hidden md:inline-flex items-center justify-center rounded-full hover:bg-surface/8 active:scale-[0.97] transition-all duration-300 ${scrolled ? "w-7 h-7 mr-1" : "w-9 h-9 mr-1.5"}`}
						>
							<svg
								viewBox="0 0 24 24"
								fill="currentColor"
						...
						<Link
							...
							target="_blank"
							className={`inline-flex  items-center justify-center gap-1.5 font-semibold rounded-full bg-accent text-surface hover:scale-[1.03] active:scale-[0.97] transition-all duration-300 px-2 md:px-4 py-1.5  ${scrolled ? "w-7 h-7 md:w-auto md:h-auto text-xs" : "w-8 h-8 md:w-auto md:h-auto text-xs"}`}
						>
							<svg
								viewBox="0 0 16 16"
								fill="none"
