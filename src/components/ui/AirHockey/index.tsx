...
export default function AirHockey() {
	...
	return (
        ...
        button:hover { background: #029bc9 !important; color: #000 !important; box-shadow: 0 0 30px rgba(0,212,255,0.5) !important; }
      `}</style>
		</div>
	);
}
...
function StatPanel({
	...
	const borderRadius = side === "left" ? "16px 0 0 16px" : "0 16px 16px 0";
	const borderStyle =
